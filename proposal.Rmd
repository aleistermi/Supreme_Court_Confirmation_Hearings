...
### Plot 2. Length of Interventions by 
...
geom_line(aes(x=year, y=length_rep, color='Republican'), data = lengths, colour = ("#DE0100")) +  
  ...
  xlab("Year") +
  ggtitle("Length of interventios during hearings by party") +
